  ...
  return (
    <>
      ...
      <main>
            ...
            <div className="story-process">
              {[
                [
                  "01",
                  "SOURCED",
                  "Directly from farmers & artisans",
                ],
                [
                  "02",
                  "QUALITY CHECKED",
        ...
        <section
          id="blog"
          className="story-section blog-placeholder"
        >
          <div className="container-wide">
            <div className="story-copy">
              <p className="eyebrow light">
                The Godavari Journal
              </p>
          ...
          <div className="container-wide quick-grid">
            {[
              ...
              [
                ...
                "Monthly delivery of your favourites.",
                "SUBSCRIBE",
              ],
              [
                "EASY REORDER",
                "Buy your past favourites in one click.",
                "REORDER NOW",
              ],
              [
                "WHATSAPP SUPPORT",
